...
public class Residuelle {
    ...
    {
    	Principal.txtTrace.setText("               | Méthode de Résiduelle |\n");
        ...
        try 
        {
        	...
        	ImageIO.write(screen, "png", new File("src\\ScreenAlgos\\FordFulkersonResiduelle.png"));
 		} catch (IOException e) {
 			e.printStackTrace();
 		}
        return maxFlow;
